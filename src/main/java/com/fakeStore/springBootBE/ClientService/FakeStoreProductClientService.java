...
@Service("fakeStoreProductClient")
public class FakeStoreProductClientService implements ProductClientService{
    ...
    public FakeStoreProductClientService(RestTemplateBuilder restTemplateBuilder) {
